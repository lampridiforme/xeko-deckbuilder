  ...
  render() {
    ...
    (((_6 = this.cardData) === null || _6 === void 0 ? void 0 : _6.cardType) === CardType.species) ?
      [
        ...
        h("div", null, h("span", { class: 'label' }, "Species Type: "), speciesTypeToString.get(this.cardData.speciesType)),
        h("div", null, h("span", { class: 'label' }, "Scientific Name: "), (_7 = this.cardData) === null || _7 === void 0 ? void 0 :
          _7.scientificName)
      ] : (((_8 = this.cardData) === null || _8 === void 0 ? void 0 : _8.cardType) === CardType.boost) ?
      // boost card case
      [] :
      // xeko card case
      [
        h("div", null, h("span", { class: 'label' }, "Required Levels: "), (this.cardData) ? Array.from((_9 = this.cardData) === null || _9 === void 0 ? void 0 : _9.requiredLevels.values()).reduce((accu, level) => `${accu}${level}, `, '') : '')
      ], h("div", null, h("span", { class: 'label' }, "Rules Text: "), (_10 = this.cardData) === null || _10 === void 0 ? void 0 :
      _10.rulesText), ((_11 = this.cardData) === null || _11 === void 0 ? void 0 : _11.flavorText) ?
      h("div", null, h("span", { class: 'label' }, "Flavor Text: "), (_12 = this.cardData) === null || _12 === void 0 ? void 0 :
        _12.flavorText) : null)));
  }
